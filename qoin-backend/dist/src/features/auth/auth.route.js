...
router.get("/user/points", verifyToken_1.verifyToken, auth_controller_1.getUserPoints);
router.get("/user/qoin-transactions", verifyToken_1.verifyToken, auth_controller_1.getQoinTransactions);
